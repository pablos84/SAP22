<?php namespace App\Http\Controllers;
	...
	class AdminAddComisionesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Fecha de Designación','name'=>'f_solicitud','type'=>'date','width'=>'col-sm-8','value'=>now()];
